...
const Task = ({ id, text, completed, onDeleteTask, listId }) => {

    const { onEditTask, onCompleteTask } = useContext(Context)

    return (
        <div key={id} className="tasks__items-row">
            <div className="tasks__items-row__item">
                <div className="checkbox">
                <input id={`task-${id}`} type="checkbox" checked={completed} onChange={(e) => onCompleteTask(listId, id, e.target.checked)} />
            ...
            <div className="tasks__items-row__item">
                <div className="tasks__items-row__actions">
                    <svg onClick={() => {
                        onEditTask(listId, {id, text})
